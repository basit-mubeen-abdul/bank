...
class MoneyTransferControllerImplTest {
    ...
    private MoneyTransferControllerImpl sut;
    ...
    @BeforeEach
    void setUp() {
        sut = new MoneyTransferControllerImpl(moneyTransferService);
    }
    ...
    void shouldCreateMoneyTransfer() {
        ...
        CreateMoneyTransferOutputDTO outputDTO = CreateMoneyTransferOutputDTO.builder()
                ...
                .build();
        given(moneyTransferService.create(INPUT_ACCOUNT_ID, inputDTO))
        ...
        verifyNoMoreInteractions(moneyTransferService);
        assertEquals(HttpStatus.OK, result.getStatusCode());
        assertEquals(EXPECTED_MONEY_TRANSFER_ID, result.getBody().moneyTransferId());
        assertEquals(EXPECTED_STATUS, result.getBody().status());
    }
}